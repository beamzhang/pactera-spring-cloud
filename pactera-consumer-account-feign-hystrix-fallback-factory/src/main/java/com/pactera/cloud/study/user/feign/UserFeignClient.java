...
@FeignClient(name = "pactera-provider-user", fallbackFactory = FeignClientFallbackFactory.class)
...
/**
 * UserFeignClient的fallbackFactory类，该类需实现FallbackFactory接口，并覆写create方法 The
